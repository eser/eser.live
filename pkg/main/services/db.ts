 ...
 * @example
 * ```ts
 * import { getQuestion } from "@/pkg/main/services/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listQuestions } from "@/pkg/main/services/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listQuestionsByUser } from "@/pkg/main/services/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { hideQuestion } from "@/pkg/main/services/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listQuestionsVotedByUser } from "@/pkg/main/services/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { updateUser } from "@/pkg/main/services/db.ts";
 *
 * await updateUser({
 *   login: "john",
 *   sessionId: crypto.randomUUID(),
 ...
 * @example
 * ```ts
 * import { updateUserSession } from "@/pkg/main/services/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { getUserBySession } from "@/pkg/main/services/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { getAreVotedByUser } from "@/pkg/main/services/db.ts";
 *
 * const questions = [
 *   {
