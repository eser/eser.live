 ...
 * @example
 * ```ts
 * import { collectValues, listQuestions, type Question } from "@/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { getQuestion } from "@/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listQuestions } from "@/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listQuestionsByUser } from "@/utils/db.ts";
 *
 ...
 * @example
 * ```ts
 * import { listQuestionsVotedByUser } from "@/utils/db.ts";
 *
