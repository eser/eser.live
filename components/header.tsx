      ...
      >
        ...
        <div class="rounded-lg bg-gradient-to-tr from-secondary to-primary p-px">
          <a
            ...
            class="flex flex-row gap-2 text-center text-white rounded-[7px] transition duration-300 px-4 py-2 block hover:bg-white hover:text-slate-900 hover:dark:bg-gray-900 hover:dark:!text-slate-100"
          >
